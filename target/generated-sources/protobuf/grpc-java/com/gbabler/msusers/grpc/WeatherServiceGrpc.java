...
public final class WeatherServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.gbabler.msusers.grpc.WeatherRequest,
      com.gbabler.msusers.grpc.WeatherResponse> getGetWeatherMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetWeather",
      requestType = com.gbabler.msusers.grpc.WeatherRequest.class,
      responseType = com.gbabler.msusers.grpc.WeatherResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.gbabler.msusers.grpc.WeatherRequest,
      com.gbabler.msusers.grpc.WeatherResponse> getGetWeatherMethod() {
    io.grpc.MethodDescriptor<com.gbabler.msusers.grpc.WeatherRequest, com.gbabler.msusers.grpc.WeatherResponse> getGetWeatherMethod;
      ...
      synchronized (WeatherServiceGrpc.class) {
        if ((getGetWeatherMethod = WeatherServiceGrpc.getGetWeatherMethod) == null) {
          WeatherServiceGrpc.getGetWeatherMethod = getGetWeatherMethod =
              io.grpc.MethodDescriptor.<com.gbabler.msusers.grpc.WeatherRequest, com.gbabler.msusers.grpc.WeatherResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetWeather"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.gbabler.msusers.grpc.WeatherRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.gbabler.msusers.grpc.WeatherResponse.getDefaultInstance()))
  ...
  public static abstract class WeatherServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getWeather(com.gbabler.msusers.grpc.WeatherRequest request,
        io.grpc.stub.StreamObserver<com.gbabler.msusers.grpc.WeatherResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.gbabler.msusers.grpc.WeatherRequest,
                com.gbabler.msusers.grpc.WeatherResponse>(
  ...
  public static final class WeatherServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<WeatherServiceBlockingStub> {
    ...
    /**
     */
    public com.gbabler.msusers.grpc.WeatherResponse getWeather(com.gbabler.msusers.grpc.WeatherRequest request) {
  ...
  public static final class WeatherServiceFutureStub extends io.grpc.stub.AbstractFutureStub<WeatherServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.gbabler.msusers.grpc.WeatherResponse> getWeather(
        com.gbabler.msusers.grpc.WeatherRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_WEATHER:
          serviceImpl.getWeather((com.gbabler.msusers.grpc.WeatherRequest) request,
              (io.grpc.stub.StreamObserver<com.gbabler.msusers.grpc.WeatherResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class WeatherServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.gbabler.msusers.grpc.Weather.getDescriptor();
    }
